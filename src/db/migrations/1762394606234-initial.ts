...
export class Initial1762394606234 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "payment" ("id" BIGSERIAL NOT NULL, "txid" character varying(255), "amount" numeric(78,0), "token" "public"."payment_token_enum", "paid" boolean NOT NULL, "memo" BIGSERIAL NOT NULL, "payload" character varying(255), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_6cfd1092a077d767a34a96588a3" UNIQUE ("txid"), CONSTRAINT "UQ_8090faf9e00030a209292e5987e" UNIQUE ("memo"), CONSTRAINT "PK_fcaec7df5adf9cac408c686b2ab" PRIMARY KEY ("id"))`,
    )
